...
<div class="row">
    <div class="col-sm-10 mx-auto">
        <div class="card border-0 shadow">
            <h4 class="mtop">Agregar Producto</h4>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action={{route('product.store')}} method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-2">
                            ...
                            <input type="number" step="0.10" class="form-control" id="inputCode" name="purchasedprice"
                                placeholder="Precio Adquirido" value="{{old('purchasedprice')}}" required>
                        </div>
                        <div class=" form-group col-md-2">
                            ...
                            <input type="number" step="0.10" class="form-control" id="inputWholesalePrice" name="wholesaleprice"
                                placeholder="Precio Mayoreo" value="{{old('wholesaleprice')}}">
                        </div>
                        <div class=" form-group col-md-2">
                            <label for="inputRetailPrice">Precio Menudeo</label>
                            <input type="number" step="0.10" class="form-control" id="inputRetailPrice"
                                name="retailprice" placeholder="Precio Menudeo" value="{{old('retailprice')}}" required>
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select id="inputCategory" class="form-control" name="category" value="{{old('category')}}">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <select id="inputAvailability" class="form-control" name="status" value="{{old('status')}}">
                    ...
                    <div class="card-group justify-content-center">
                        <div class="card marginr" style="width: 18rem;">
                            <div class="img-wrap">
                                <img src="https://ui-avatars.com/api/?name=1&size=255" class="card-img-top" alt="..."
                                    id="image1">
                            </div>
                            <div class="card-body">
                                <h5 class="card-title">Imagen 1</h5>
                                <input accept="image/*" type="file" name="image1" id="image1" value="{{old('image1')}}"
                                    class="form-control-file file1" required>
                        ...
                        <div class="card marginr" style="width: 18rem;">
                            <div class="img-wrap">
                                <img src="https://ui-avatars.com/api/?name=2&size=255" class="card-img-top" alt="..."
                                    id="image2">
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card" style="width: 18rem;">
                            <div class="img-wrap">
                                <img src="https://ui-avatars.com/api/?name=3&size=255" class="card-img-top" alt="..."
                                    id="image3">
                            </div>
                            <div class="card-body">
                    ...
                    @csrf
                    <button type="submit" class="btn btn-primary mtop">Guardar</button>
                </form>
            </div>
        </div>
        @stop